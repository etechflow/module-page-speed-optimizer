...
class Activated extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $block = $page->getLayout()->getBlock('etechflow.pso.license.activated');
        if ($block) {
            $block->setData('license_key', $licenseKey)
                  ->setData('plan', $planName)
                  ->setData('error', $error)
                  ->setData('settings_url', $this->getUrl('adminhtml/system_config/edit/section/etechflow_pso'))
                  ->setData('management_url', $this->getUrl('etechflow_pso/diagnose/index'));
        }
